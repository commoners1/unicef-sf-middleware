...
### Application Scaling
- **Main App**: 2 replicas (cluster mode)
- **Salesforce Workers**: 5 instances
- **Email Workers**: 3 instances
- **Notification Workers**: 3 instances
...
pm2 logs sf-middleware-prod --lines 100 | grep -i memory
```
...
pm2 restart sf-worker-prod-salesforce
```
