// src/queue/services/job-scheduler.service.ts
...
export class JobSchedulerService {
  ...
  async scheduleRecurringJobs() {
    ...
    if (this.cronJobStateService && !this.cronJobStateService.isJobEnabled('recurring')) {
  ...
  async schedulePledgeJobs() {
    // Check if job is enabled
    if (this.cronJobStateService && !this.cronJobStateService.isJobEnabled('pledge')) {
  ...
  async scheduleOneOffJobs() {
    // Check if job is enabled
    if (this.cronJobStateService && !this.cronJobStateService.isJobEnabled('oneoff')) {
  ...
  async scheduleHourlyJobs() {
    // Check if job is enabled
    if (this.cronJobStateService && !this.cronJobStateService.isJobEnabled('hourly')) {
